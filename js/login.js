...
$(document).ready(function(){
  ...
  $('#login_userbttn').click(function(){
    ...
    setTimeout(function(){
	    if ( $('#userid').val() != "" && $('#password').val() != "" ){
		    ...
		    $.ajax({
			    type: 'POST',
			    url: 'index.php?ctrl=Login&accion=Verificar',
			    data: 'login_name=' + $('#userid').val() + '&login_pass=' + $('#password').val(),
			    dataType : 'json',
  ...
  $('#sessionKiller').click(function(){
	  ...
	  $('.box-success').slideDown(timeSlide);
	  setTimeout(function(){
		  window.location.href = "index.php?controlador=login&accion=deslogearse";
	  },300);
  });
